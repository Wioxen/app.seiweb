				...
				<div class="page-inner">
					<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
						<div>
							...
							<h6 id="data-hora" class="op-7 mb-2"></h6>
						</div>
			...
			<footer class="footer">
				<div class="container-fluid">
					...
					<div class="copyright ms-auto">
						2025, Sistema 2 <i class="fa fa-heart heart text-danger"></i> by <a href="https://www.seiweb.com.br">SEIWEB</a>
					</div>				
				</div>
			</footer>
		</div>	
...
<script src="js/usuarioacesso.js"></script>
<script>
                        ...
                        menuHTML += `
                            <li class="">
								<a href="#" data-modulo="${submenu.modulo}" id="${submenu.elemento_id}" onclick="${submenu.elemento_id}Click(this);">
                                    <span class="sub-item"> ${submenu.titulo} </span>
                                </a>
							</li>`;
                    });
                }
